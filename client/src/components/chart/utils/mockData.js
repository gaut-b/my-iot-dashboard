...
export const initData = (length = 100) => {
	let lastTemperature = randomAroundMean(25, 5);
...
export const addData = (data = []) => {
	...
	...data,
	{
		date: formatDate(d3.timeDay.offset(today, data.length - 100)),
		temperature: lastData.temperature + randomAroundMean(0, 2)
	}]
